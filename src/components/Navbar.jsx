        ...
        <div>
            <nav className="border-gray-200 bg-yellow-500 shadow-md shadow-yellow-50  sticky w-full top-0">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <button onClick={navbarToggle} type="button" className="inline-flex bg-yellow-50 items-center p-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
                    ...
                    <div className={isCollapse ? 'hidden w-full md:block md:w-auto' : 'w-full md:block md:w-auto'}>
                        <ul className="flex flex-col font-medium mt-4 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-transparent">
                            <li className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-yellow-100 md:p-0">
