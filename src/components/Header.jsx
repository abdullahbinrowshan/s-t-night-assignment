    ...
    return (
        <div id='header'>
            <div className='bg-slate-700 flex flex-col justify-center text-center space-y-4 bg-opacity-70  h-[75vh] mt-1 lg:p-28 p-2'>
                <h1 className=' text-white font-bold text-4xl md:text-6xl'>Welcome to <span className='underline decoration-yellow-500 decoration-4 underline-offset-4 text-yellow-200'>QuizzyBee</span></h1>
